...
/* @author Misha Koryak
 * @projectDescription lock a table nav in place while scrolling - without breaking styles or events bound to the nav
 *
 * Dependencies:
...
(function( $ ) {
  ...
  $.floatThead.defaults = {
    ...
    top: 0, //String or function($table) - offset from top of window where the nav should not pass above
    bottom: 0, //String or function($table) - offset from the bottom of the table where the nav should stop scrolling
    ...
    enableAria: false, //will copy nav text from the floated nav back into the table for screen readers. Might cause the css styling to be off. beware!
  ...
  $.fn.floatThead = function(map){
    ...
    this.filter(':not(.'+opts.floatTableClass+')').each(function(){
      ...
      function unfloat(){ //put the nav back into the table
        if(headerFloated){
          headerFloated = false;
          if(useAbsolutePositioning){ //#53, #56
      ...
      var isHeaderFloatingLogical = false; //for the purpose of this event, the nav is/isnt floating, even though the element
                                           //might be in some other state. this is what the nav looks like to the user
      ...
      /**
       * returns a function that updates the floating nav's cell widths.
       * @return {Function}
       */
      function reflow(){
        var i;
        ...
        return function(eventType){
          ...
          if(locked && useAbsolutePositioning){ //inner scrolling, absolute positioning
            ...
            if(windowTop > floatEnd + tableHeight + captionScrollOffset){
              ...
              refloat(); //scrolling within table. nav floated
              triggerFloatEvent(true);
            }
            left =  0;
            ...
            if(windowTop > floatEnd + tableHeight + captionScrollOffset){
              ...
              top = tableOffset.top - windowTop;
              refloat();
              triggerFloatEvent(false); //this is a weird case, the nav never gets unfloated and i have no no way to know
