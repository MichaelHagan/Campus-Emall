...
var Grid = fc.Grid = RowRenderer.extend({
	...
	// Used by the `headHtml` method, via RowRenderer, for rendering the HTML of a day-of-week nav cell
	// TODO: move to another class. not applicable to all Grids
	headCellHtml: function(cell) {
		...
		return '' +
			'<th class="fc-day-nav ' + view.widgetHeaderClass + ' fc-' + dayIDs[date.day()] + '">' +
...
var DayGrid = Grid.extend({
	...
	// Computes a default column nav formatting string if `colFormat` is not explicitly defined
	computeColHeadFormat: function() {
...
DayGrid.mixin({
	...
	showSegPopover: function(cell, moreLink, segs) {
		...
		if (this.rowCnt == 1) {
			topEl = view.el; // will cause the popover to cover any sort of nav
		}
		else {
	...
	renderSegPopoverContent: function(cell, segs) {
		...
		var content = $(
			'<div class="fc-nav ' + view.widgetHeaderClass + '">' +
				'<span class="fc-close ' +
...
var View = fc.View = Class.extend({
	...
	title: null, // the text that will be displayed in the nav's title
	...
	initThemingProps: function() {
		...
		this.widgetHeaderClass = tm + '-widget-nav';
	...
	computeScrollerHeight: function(totalHeight) {
		...
		var both;
		var otherHeight; // cumulative height of everything that is not the scrollerEl in the view (nav+borders)
...
----------------------------------------------------------------------------------------------------------------------*/
// TODO: rename all nav-related things to "toolbar"
...
var BasicView = fcViews.basic = View.extend({
	...
	headRowEl: null, // the fake row element of the day-of-week nav
	...
	// Generates the HTML that will go before the day-of week nav cells.
	...
	setHeight: function(totalHeight, isAuto) {
		...
		if (!isAuto) { // should we force dimensions of the scroll container, or let the contents be natural height?
			...
			if (setPotentialScroller(this.scrollerEl, scrollerHeight)) { // using scrollbars?
				...
				// make the all-day and nav rows lines up
