...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        sorting: false,
        sortableClass: "jsgrid-nav-sortable",
        sortAscClass: "jsgrid-nav-sort jsgrid-nav-sort-asc",
        sortDescClass: "jsgrid-nav-sort jsgrid-nav-sort-desc",
        ...
        gridHeaderClass: "jsgrid-grid-nav",
        ...
        _createHeader: function() {
            ...
            var $header = this._header = $("<div>").addClass(this.gridHeaderClass)
                .addClass(this._scrollBarWidth() ? "jsgrid-nav-scrollbar" : "")
                .append($headerGrid);
