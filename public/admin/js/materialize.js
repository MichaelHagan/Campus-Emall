...
Vel = $ ? $.Velocity : Velocity, function(a) {
    a.fn.collapsible = function(b) {
        ...
        return b = a.extend(c, b), this.each(function() {
            function c(b) {
                h = g.find("> li > .collapsible-nav"), b.hasClass("active") ? b.parent().addClass("active") : b.parent().removeClass("active"), 
            ...
            function f(a) {
                return a.closest("li > .collapsible-nav");
            }
            var g = a(this), h = a(this).find("> li > .collapsible-nav"), i = g.data("collapsible");
            g.off("click.collapse", ".collapsible-nav"), h.off("click.collapse"), b.accordion || "accordion" === i || void 0 === i ? (h = g.find("> li > .collapsible-nav"), 
    ...
    var b = {
        init: function(b) {
            ...
            b = a.extend(c, b), a(this).each(function() {
                ...
                }), b.closeOnClick === !0 && e.on("click.itemclick", "a:not(.collapsible-nav)", function() {
                    c();
                });
                var g = !1, h = !1;
                f.on("click", function() {
