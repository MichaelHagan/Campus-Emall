...
<link rel="stylesheet" type="text/css" href="{{ asset('css/styles/categories_styles.css') }}">
                  ...
                  <div class="product-item accessories">
                    <div class="product discount product_filter">
                      ...
                      <div class="product_info">
                        <h6 class="product_name"><a href="single.html">{{ $product->productName }} {{ $product->description }}</a></h6>
                        <div class="product_price">GH {{ $product->discount }}<span>GH {{ $product->Price }}</span></div>
                        
                      </div>
                    </div>
                    <div class="red_button add_to_cart_button"><a class="add_cart" href="">add to cart<span id="id" style="display: none;">{{ $product->id }}</span></a></div>
                  </div>
                @endforeach
                </div>
                <!-- Product Sorting -->
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="newsletter_text d-flex flex-column justify-content-center align-items-lg-start align-items-md-center text-center">
            <h4><a href="{{ route('shop.cat') }}">newsletter</a></h4>
...
<script type="text/javascript">
     ...
     //Scripts for removing an item from the cart 
      $(document).on('click','.add_cart',function(event){
        ...
        var id = $.trim(id);
        console.log(id);
        $.post("{{route('cart.create')}}",{id:id, _token:csrfToken},function(data){
          console.log(data);
